...
plt.ioff()
plt.show()
plt.savefig(os.path.join(save_dir, "DoubleDQN_cartpole.png"))

# 保存训练好的模型
model_path = os.path.join(save_dir, "double_dqn_cartpole.pth")
...
video_name = f"cartpole_DoubleDQN_{current_time}"
